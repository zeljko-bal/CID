...
# zavrsiti checkove za cli [v]
# {options} [v]
# importovanje [v]
# konverzija tipova u invoke [v]
# razdvojiti u fajlove sta je zajednicko / sta je samo za cli [v]
...
# kad se importuje skripta u procesorima da se preskacu elementi koji se ne koriste [x]

# da se usage linije u helpu wrapuju kao desc [v]
# da moze --help sa ostalim paramima [v]
# da kad se dodeljuje default za named tuple parame da se konstruise taj tuple (proslediti vars) [v]
# da kad se dodeljuje default za multiplicity ili count = many da se napravi list() [v]

# choices custom code []
# da se help prosledi kao rows, pa da se u cli_parser wrapuje na osnovu http://stackoverflow.com/questions/566746/how-to-get-console-window-width-in-python []
# da se u exception pakuje za koju komandu se desio/koje su uspesno prepoznate, da moze da se ispise help []